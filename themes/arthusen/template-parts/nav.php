<header>
    ...
    <div class="arthusen">
        <a href="<?php echo $site_url ?>" class="arthusen">
            <h2><?php echo $site_title; ?></h2>
        </a>
    </div>

    <div class="cart-menu">
        <a href="http://localhost:8888/wordpress/my-account/" class="account-text">
            <?php
        ...
        <div class="cart-icons">
            <a href="http://localhost:8888/wordpress/cart/"><svg width="28" height="37" viewBox="0 0 28 37" fill="none" xmlns="http://www.w3.org/2000/svg">
